...
urlpatterns = [
    path('', RedirectView.as_view(url='/lab-6/', permanent='true'), name='index'),
    ...
    path('lab-5/', include(('lab_5.urls', 'lab-5'), namespace='lab-5')),
    path('lab-6/', include(('lab_6.urls', 'lab-6'), namespace='lab-6')),
]
